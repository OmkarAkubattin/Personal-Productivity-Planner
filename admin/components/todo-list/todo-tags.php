                        ...
                        <div class="col" style="padding-right:0;">
                            <div class="card mb-4" style="border: 0px;border-right: 1px solid #e3e6f0;border-radius: 0;">
                                <div class="card-body">
                                    ...
                                    <?php 
                                    $result=sql_query("SELECT * FROM `todo` WHERE `fk_user`='$id' and `status`= 0 and `trash`= 0 and `tag`= '".$_GET['tag']."'");
                                    ...
                                    while($row = mysqli_fetch_assoc($result)){
                                        ...
                                        echo '
                                        <form action="todo-tags.php" method="POST">
                                        ...
                                        <div class="todo-item">                                     
                                            ...
                                            echo'&nbsp;On&nbsp;<span class="time">';if(strval(date('H:i', $time))!="00:00"){echo $strtime;} echo '</span><button type="submit" name="del-task" value="'.$row['id'].'" class="close ml-3" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    </span>
                                ...
                                <div class="card mb-4" style="border: 0px;border-radius: 0;">
                                    ...
                                    if($_SERVER['REQUEST_METHOD']=="POST" && isset($_POST['open-task'])){
                                        ...
                                        if (mysqli_num_rows($result) >0) {
                                            ...
                                            <input onChange="this.form.submit()" style="border:none;" name="date-change" type="date" value="'.$strdate.'" ">
